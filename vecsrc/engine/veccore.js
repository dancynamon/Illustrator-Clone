...
const VECCORE = (() => {
  ...
  function demoDoc() {
    ...
    addShape(doc, {
      ...
      fill: '#6cb33f',
      fillInfo: { space: 'separation', name: DEMO_SPOT, values: [1], alt: { space: 'cmyk', values: [0.4, 0, 0.65, 0.3] } },
    ...
    doc.swatches = [{
      space: 'separation', values: [1], rgb: [0.42, 0.7, 0.25], name: DEMO_SPOT,
      alt: { space: 'cmyk', values: [0.4, 0, 0.65, 0.3] }, uses: 1,
    }];
    return doc;
  }
